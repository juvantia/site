    ...
    const timelineSteps = [
        {
            ...
            description: "JUVANTIA secures the physical territory for the park. The official map and landscape are revealed, signaling readiness for construction.",
            icon: "📋",
        ...
        },
        {
            ...
            description: "Build and install your Shelter yourself in the park",
            duration: "3-6 months",
            icon: "🔨",
            isWindow: true,
                    ...
                    <div style={{ width: isMobile ? '100%' : '50%' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            {[
                                ...
                                { title: 'Charging Station', text: 'Safe, dedicated space for your Robulus to recharge on the park’s standardized 24V grid.' },
                ...
                <div style={{
                    ...
                    <div style={{ width: isMobile ? '100%' : '50%' }}>
                        ...
                        <p style={{
                            ...
                            We expect your Shelter to be aesthetically pleasing and contribute to the park's visual identity.
                        </p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            {[
                    ...
                    <div style={{
                        ...
                        <div style={{ width: isMobile ? '100%' : '60%' }}>
                            ...
                            <p style={{
                                ...
                                All Shelter structures connect to the park grid via the standard 24V <span style={{ color: 'var(--color-primary)', fontWeight: 500 }}>GX16-4</span> plug connector.
                            </p>
                            <p style={{
                                ...
                                This GX16-4 connector powers your Shelter from the JUVANTIA park electrical network.
                            </p>
                        </div>

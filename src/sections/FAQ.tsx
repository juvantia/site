...
const faqItems: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "The entire JUVANTIA economy operates strictly on Euro-backed electronic money. All settlements, automated rentals, and asset sales are processed in Euros via secure, non-custodial accounts managed directly from your device using biometrics (Face ID, or fingerprint authentication)."
    },
    {
        id: 'prove-ownership',
        question: "HOW DO I PROVE OWNERSHIP OF MY PHYSICAL ASSETS (ROBULUS, DOMUS OR SECTOR)?",
        answer: "Upon registering your physical asset with the park, JUVANTIA issues a secure digital passport for your property and transfers 100% digital ownership directly to your account."
    },
    {
        id: 'sell-transfer-asset',
        question: "CAN I SELL OR TRANSFER MY ROBULUS, DOMUS, OR SECTOR?",
        answer: "Yes. Every physical asset in the park has a secure digital passport. You can list your full asset or sell fractional shares to other participants on the Trade Hub secondary marketplace at any time."
    },
    {
        id: 'sell-fractionally',
        question: "CAN I SELL MY ASSET FRACTIONALLY (PARTIALLY)?",
        answer: "Yes, absolutely. You can sell any percentage share of your asset at any price you consider fair on the Trade Hub."
    },
    {
        id: 'ownership-control',
        question: "DOES OWNERSHIP PERCENTAGE AFFECT CONTROL OVER THE ASSET?",
        answer: "Yes. The park recognizes as the asset operator the participant holding a 51% stake or backed by 51% of co-owners' votes. For example, if you own 45% of a Robulus, you remain its operator as long as other owners holding at least 6% vote for you. If co-owners holding 51% vote to reassign control to another driver, you relinquish operational teleoperation rights while fully retaining your 45% ownership share and yield rights."
    },
    {
        id: 'permanently-remove-robulus',
        question: "CAN I PERMANENTLY REMOVE MY ROBULUS FROM THE PARK FOR MAINTENANCE OR PERSONAL USE?",
        answer: "Yes, provided you own 100% of the asset passport. If you have sold fractional shares, you must either obtain formal authorization from the majority of co-owners via vote or deposit a full market value collateral on the day of retrieval."
    },
    {

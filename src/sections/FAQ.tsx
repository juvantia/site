...
const faqItems: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "An APU (Asset Passport Unit) is the secure digital passport for a physical asset in JUVANTIA (Robulus, Domus, or Sector). APUs certify property ownership and automatically distribute all rental income, commercial revenues, and operational yield generated by that physical asset directly to the APU holder's account in Euros."
    },
    {
        id: 'currency',
